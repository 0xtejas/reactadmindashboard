...
const Sidebar = () => {
  ...
  const activeLink = 'flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg dark:text-white text-md m-2 text-black'
        ...
        <>
          <div className='flex justify-between items-center'>
            ...
            <TooltipComponent content="Menu">
              <button type='button'
              onClick={() => setActiveMenu((prevActiveMenu) => !prevActiveMenu)} className='text-xl rounded-full p-3 hover:bg-gray-500 mt-4 block md:hidde'>
                <MdOutlineCancel />
              </button>
            </TooltipComponent>
          </div>
